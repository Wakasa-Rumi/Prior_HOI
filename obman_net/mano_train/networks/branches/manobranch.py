...
from obman_net.handobjectdatasets.queries import TransQueries, BaseQueries
...
class ManoLoss:
    ...
    def compute_myloss(self, preds_verts, pred_joints, 
                       target_verts, target_joints,
                       pred_shape, pred_pose):
        final_loss = 0
        
        verts3d_loss = torch_f.mse_loss(preds_verts, target_verts)
        final_loss += self.lambda_verts * verts3d_loss
